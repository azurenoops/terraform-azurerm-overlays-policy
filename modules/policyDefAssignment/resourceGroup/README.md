# Policy Definition Assignment - Resource Group

Assignments can be scoped to individual resource groups. This is useful for assigning policies to resources that are not yet managed by a management group.
